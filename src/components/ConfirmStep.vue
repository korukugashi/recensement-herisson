<template>
  <div class="notification is-alert" v-if="error !== null">
    ...
    <p>Veuillez <a href="javascript:window.location.href=atob('bWFpbHRvOmhlcmlzc29uQGZuZTI1LmZy')">nous envoyer un email</a> pour nous signaler ce dysfonctionnement.</p>
  </div>
