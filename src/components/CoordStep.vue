<template>
  ...
  <div class="is-flex mt-5" style="justify-content: space-between; align-items: center">
    ...
    <router-link :to="{ name: 'avis' }" class="button is-success is-large" :class="{'is-disabled': isNextDisabled}" @click="clickWard">Suivant &#8250;</router-link>
  </div>
...
export default {
  ...
  computed: {
    isNextDisabled() {
      return !this.form.name || !this.form.firstname || !this.form.email || !this.form.email.match(
